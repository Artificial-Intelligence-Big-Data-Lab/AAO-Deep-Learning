...
experiments = [
                '015 - 28gennaio - ripetizione 012', # 1 walk 90 reti 1500epoche
                #'026 - BIG - test lungo', # 1 walk 90 reti 1500epoche
                #'025 - BIG rilanciato - validation singolo, loss 15, no class_w - 90 reti', # 1 walk 90 reti 1500epoche
                #'024 - BIG corretto - validation singolo, loss 15, no class_w - 100 reti', # 1 walk 100 reti 1500epoche
...
for experiment_name in experiments: 
    for index_walk in range(16, MAX_WALK):
