...
iperparameters = { 
                'experiment_name': '134 - SP500 walk 1 anno sino al 2020 sp500 e vix pesi bilanciati',
                ...
                'verbose': True,
                'multivariate': True,
                'experiment_path': '/media/unica/HDD 9TB Raid0 - 1/experiments/', 
                'description': '<p>Ripetizione dell\'exp n° 132. In questo esperimento viene usata una rete multivariate con pesi loss bilanciati. Il segnale usato in input è [(c-o) / o] di sp500 e vix con risoluzione 1h e 1d. <br>Questo esperimento è stato lanciato in coppia con il numero <b>131</b> con lo stesso identico setup ad eccezione dei pesi loss. Lo scopo dei due exp in coppia è quello di vedere come cambiano i risultati al variare dei pesi loss.</p>'
}
