...
iperparameters = { 
                'experiment_name': '011 - Test con pattern SCORRELATO Single Res',
                ...
                'input_images_folders': ['sp500_cet_WITH_PATTERN_SCORRELATO/1hours/gadf/delta_current_day_percentage/'],
                'predictions_images_folder': 'sp500_cet_WITH_PATTERN_SCORRELATO/1hours/gadf/delta_current_day_percentage/',
                'input_shape': (20,20,3),
