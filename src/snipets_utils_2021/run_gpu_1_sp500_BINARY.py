...
iperparameters = { 
                'experiment_name': '008 - 96Sample 5min -  BS 128 LR 0.0005 SGD',
                ...
                'input_images_folders': ['sp500_cet_perc_50/5min/gadf/delta_current_day_percentage/'],
                'predictions_images_folder': 'sp500_cet_perc_50/5min/gadf/delta_current_day_percentage/',
                #'input_shape': (96, 96, 3),
                'input_shape': (96, 96, 3),
