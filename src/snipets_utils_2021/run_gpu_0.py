...
iperparameters = { 
                'experiment_name': '129 - SP500 walk 1 anno sino al 2020 pesi bilanciati',
                ...
                'input_images_folders': ['merge/merge_sp500_cet/gadf/delta_current_day/'],
                'predictions_images_folder': 'merge/merge_sp500_cet/gadf/delta_current_day/',
                'input_shape': (40,40,3),
                ...
                'verbose': True,
                'multivariate': True,
                'description': '<p>Coppia di exp 129 e 130 con pesi bilanciati. Si sta indagando sull\'effetto dei pesi loss sui risultati. Il confronto è tra 129 (usando solo i prezzi) vs 130 (usando anche skew e vix).</p>'
                }
