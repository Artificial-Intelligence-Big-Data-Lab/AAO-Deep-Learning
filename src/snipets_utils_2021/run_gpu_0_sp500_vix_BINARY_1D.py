...
iperparameters = { 
                'experiment_name': '012 - Test con pattern FORTE CNN1D single-res',
                ...
                'init_lr': 0.0001, # dimensione learning rate
                ...
                'input_images_folders': ['merge/merge_sp500_cet_WITH_PATTERN_FORTE/gadf/delta_current_day_percentage/'],
                'predictions_images_folder': 'merge/merge_sp500_cet_WITH_PATTERN_FORTE/gadf/delta_current_day_percentage/',
                'input_shape': (4, 20),
...
#vgg.run_1D(dataset='sp500_cet_WITH_PATTERN_DEBOLE', start_index_walk=arguments.start_index_walk, gpu_id=os.environ["CUDA_VISIBLE_DEVICES"])
