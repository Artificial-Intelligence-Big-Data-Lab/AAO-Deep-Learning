...
iperparameters = { 
                'experiment_name': '133 - SP500 walk 1 anno sino al 2020 sp500 e vix pesi short',
                ...
                'description': '<p>In questo esperimento viene usata una rete multivariate con pesi loss sbilanciati verso le short. Il segnale usato in input è [(c-o) / o] di sp500 e vix con risoluzione 1h e 1d. <br>Questo esperimento è stato lanciato in coppia con il numero <b>132</b> con lo stesso identico setup ad eccezione dei pesi loss. Lo scopo dei due exp in coppia è quello di vedere come cambiano i risultati al variare dei pesi loss.</p>'
}
