...
iperparameters = { 
                'experiment_name': '006 - 20Sample 1h - BS 128 LR 0.0005 SGD',
                'epochs' : 1000, # n° epoche per il training
                ...
                'init_lr': 0.0005 , # dimensione learning rate
                ...
                'input_images_folders': ['sp500_cet_perc_50/1hours/gadf/delta_current_day_percentage/'],
                'predictions_images_folder': 'sp500_cet_perc_50/1hours/gadf/delta_current_day_percentage/',
                #'input_shape': (96, 96, 3),
                'input_shape': (20, 20, 3),
                ...
                'multivariate': False,
                'balance_binary': True,
                'experiment_path': '/media/unica/HDD 9TB Raid0 - 1/experiments-binary-a-50/', 
...
#vgg.run_1D(dataset='sp500_cet_WITH_PATTERN_FORTE', perc=200, start_index_walk=arguments.start_index_walk, gpu_id=os.environ["CUDA_VISIBLE_DEVICES"])


if 'experiment_path' in iperparameters: 
        generate_results(experiment_name=iperparameters['experiment_name'], experiment_path=iperparameters['experiment_path'], single_net=False)
else: 
