...
iperparameters = { 
                'experiment_name': '013 - Test con pattern MEDIO CNN1D single-res',
...
#vgg.run_1D(dataset='sp500_cet_WITH_PATTERN_SCORRELATO', start_index_walk=arguments.start_index_walk, gpu_id=os.environ["CUDA_VISIBLE_DEVICES"])
