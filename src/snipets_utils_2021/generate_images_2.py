...
for symbol in symbols:
    ...
    one_h = market.get_binary_labels(freq='1h', thr=-0.5, columns=['delta_current_day_percentage', 'delta_current_day'])
    ...
    #gaf.run(df=one_h, dataset_name=symbol, subfolder="1hours", type='gadf', size=20, columns=['delta_current_day', 'delta_current_day_percentage'])
    gaf.run_with_syntetic(df=one_h, dataset_name=symbol, subfolder="1hours", type='gadf', size=20, columns=['delta_current_day_percentage'])
