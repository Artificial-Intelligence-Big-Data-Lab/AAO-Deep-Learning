...
class ImagesMerger:
    ...
    def __validate(self, input_folders=None, resolutions=None, signals=None, positions=None, type='gadf', img_size=None, output_path=""):
        ...
        if len(resolutions) != len(positions):
            sys.exit("ImagesMerger.__validate: input_folders and position parameters must have equal lenght. resolutions len: " + str(len(resolutions)) + ", positions len: " + str(len(positions)))
