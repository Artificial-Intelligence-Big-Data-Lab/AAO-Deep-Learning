...
training_set = [['2000-01-01', '2010-04-30'], 
 ...
 ['2000-01-01', '2018-04-30'], 
 ]

validation_set = [['2010-05-01', '2010-12-31'], 
...
test_set = [['2011-01-01', '2011-08-31'], 
        ['2011-09-01', '2012-04-30'], 
        ['2012-05-01', '2012-12-31'], 
        ['2013-01-01', '2013-08-31'], 
        ['2013-09-01', '2014-04-30'], 
        ...
        ['2017-09-01', '2018-04-30'], 
        ['2018-05-01', '2018-12-31'], 
        #['2019-01-01', '2019-08-31'], #non allineato
        ['2019-01-01', '2019-12-31'], #allineato con il test set
]

iperparameters = { 
                'experiment_name': '113 - SP500 univariate blocco unico 1h 20x20 100 reti walk 8 mesi allineati',
