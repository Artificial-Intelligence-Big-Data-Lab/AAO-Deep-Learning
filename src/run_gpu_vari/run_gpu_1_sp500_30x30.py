...
iperparameters = { 
                'experiment_name': '108 - SP500 univariate blocco unico 1h 30x30 100 reti',
                ...
                'input_images_folders': ['sp500_cet/1hour_30x30/gadf/delta_current_day/'],
                'predictions_images_folder': 'sp500_cet/1hour_30x30/gadf/delta_current_day/',
                'input_shape': (30,30,3),
                'stop_loss': 1000, 
                'penalty': 25,
                'hold_labeling': 0.3,
