...
iperparameters = { 
                'experiment_name': 'Applied Intelligence - AAPL 2',
                ...
                'input_datasets': ['aapl'],
                'predictions_dataset': 'aapl',
                'input_images_folders': ['merge/merge_aapl/gadf/delta/'],
                'predictions_images_folder': 'merge/merge_aapl/gadf/delta/',
                'input_shape': (40,40,3),
                'stop_loss': 1000, 
                'penalty': 25,
                'hold_labeling': 0.3,
