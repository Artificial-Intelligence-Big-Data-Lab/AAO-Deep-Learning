...
training_set = [ ['1998-01-01', '2006-12-15'] ]
validation_set = [ ['2002-12-16', '2006-12-31'] ]
test_set = [ ['2007-01-01', '2019-07-01'] ]

iperparameters = { 
                'experiment_name': 'Applied Intelligence - AMZN',
                ...
                'input_datasets': ['amzn'],
                'predictions_dataset': 'sp5amzn00',
                'input_images_folders': ['merge/merge_amzn/gadf/delta/'],
                'predictions_images_folder': 'merge/merge_amzn/gadf/delta/',
                'input_shape': (40,40,3),
                'stop_loss': 1000, 
                'penalty': 25,
                'hold_labeling': 0.3,
