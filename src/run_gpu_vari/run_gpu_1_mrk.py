...
iperparameters = { 
                'experiment_name': 'Applied Intelligence - MRK',
                ...
                'input_datasets': ['mrk'],
                'predictions_dataset': 'mrk',
                'input_images_folders': ['merge/merge_mrk/gadf/delta_current_day/'],
                'predictions_images_folder': 'merge/merge_mrk/gadf/delta_current_day/',
                'input_shape': (40,40,3),
                'stop_loss': 1000, 
                'penalty': 25,
                'hold_labeling': 0.3,
