...
iperparameters = { 
                'experiment_name': '092- Test multivariate SP500 tutti i blocchi delta percentuale',
                ...
                'input_images_folders': ['merge/merge_sp500_cet_percentage/gadf/delta_current_day_percentage/'],
                'predictions_images_folder': 'merge/merge_sp500_cet_percentage/gadf/delta_current_day_percentage/',
                'input_shape': (40,40,3),
                'stop_loss': 1000, 
                'penalty': 25,
                'hold_labeling': 0.3,
