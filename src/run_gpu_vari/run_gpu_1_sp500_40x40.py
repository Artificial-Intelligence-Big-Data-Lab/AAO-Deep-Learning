...
iperparameters = { 
                'experiment_name': '105 - SP500 univariate blocco unico 1h 40x40',
                ...
                'input_images_folders': ['sp500_cet_40x40/1hour/gadf/delta_current_day/'],
                'predictions_images_folder': 'sp500_cet_40x40/1hour/gadf/delta_current_day/',
                'input_shape': (40,40,3),
                'stop_loss': 1000, 
                'penalty': 25,
                'hold_labeling': 0.3,
