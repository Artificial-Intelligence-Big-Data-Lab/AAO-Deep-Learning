...
iperparameters = { 
                'experiment_name': 'Applied Intelligence - JPM',
                ...
                'input_datasets': ['jpm'],
                'predictions_dataset': 'jpm',
                'input_images_folders': ['merge/merge_jpm/gadf/delta/'],
                'predictions_images_folder': 'merge/merge_jpm/gadf/delta/',
                'input_shape': (40,40,3),
                'stop_loss': 1000, 
                'penalty': 25,
                'hold_labeling': 0.3,
