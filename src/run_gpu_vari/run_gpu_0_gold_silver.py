...
iperparameters = { 
                'experiment_name': '073 - gold and gold silver - pesi bilanciati',
                ...
                'input_images_folders': ['merge/merge_gold_cet_with_gold_vs_silver/gadf/delta_current_day/'],
                'predictions_images_folder': 'merge/merge_gold_cet_with_gold_vs_silver/gadf/delta_current_day/',
                'input_shape': (40,40,3),
                'stop_loss': 1000, 
                'penalty': 25,
                'hold_labeling': 0.3,
