...
iperparameters = { 
                'experiment_name': '056e - Multivariate CNN 3Liv Conv - Tuning Parametri - Adam Pesi Sbilanciati Long Short',
                'epochs' : 800, # n° epoche per il training
                ...
                'predictions_images_folder': 'merge/merge_sp500_cet_test_multivariate/gadf/multivariate/',
                'input_images_folders': ['merge/merge_sp500_cet_test_multivariate/gadf/multivariate/'],
                'input_shape': (40,80,3), # H * W * C
